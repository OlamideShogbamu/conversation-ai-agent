...
│   │   └── ingest.py            # products.md parser & Qdrant ingest
│   ├── db/
...
├── scripts/
│   ├── ingest_products.py       # Clear Qdrant and re-ingest products.md
...
├── products.md                 # Product catalog source
...
Parses `products.md`, generates embeddings, and stores them in Qdrant. Clears any existing vector data first.
...
```bash
python scripts/ingest_products.py   # resets Qdrant + re-ingests products.md
